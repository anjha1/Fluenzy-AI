...
export async function GET(
  ...
  try {
    ...
    // Admin access — no publicProfileEnabled check. All sections visible.
    ...
    return NextResponse.json({
      // Admin-only metadata — indicates whether this profile is publicly visible
      publicProfileEnabled: profile.publicProfileEnabled,
      // Profile data in the same shape as /api/public-profile/[username]
      profile: {
        ...
        // All sections always visible to admin
        publicSections: {
          skills: true,
          experience: true,
          education: true,
